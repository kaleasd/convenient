...
import com.gyh.internalcommon.dto.serviceverificationcode.request.VerifyCodeRequest;
...
public class ServiceVerificationCodeRestTemplateServiceImpl implements ServiceVerificationCodeRestTemplateService {
    ...
    public ResponseResult generatorCode(int identity, String phoneNumber) {
        ...
        ResponseResult result = restTemplate.exchange(url, HttpMethod.POST, new HttpEntity<Object>(null, null), ResponseResult.class).getBody();
        return result;
    }

    @Override
    public ResponseResult verifyCode(int identity, String phoneNumber, String code) {
        String url = "http://service-verifyication-code/verify-code/verify/";
