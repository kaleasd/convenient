...
import com.gyh.servicefile.utils.OssApiConfig;
...
public class StsService {
    ...
    public AssumeRoleResponse assumeRole(String roleSessionName) throws ClientException {
        DefaultProfile profile = DefaultProfile.getProfile(REGION_CN_BEIJING, ossApiConfig.getAccessId(), ossApiConfig.getAccessKey());
